    ...
    <div className="max-w-7xl mx-auto space-y-16 pb-24 relative">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-8 relative z-10 p-2">
         ...
         <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }}>
            <Link
              to="/admin/new"
              className="group relative flex items-center gap-4 bg-white text-black pl-8 pr-12 py-5 rounded-[2rem] font-black uppercase tracking-widest text-[10px] hover:bg-emerald-500 transition-all shadow-[0_20px_40px_rgba(255,255,255,0.05)] active:scale-95"
            >
              <div className="absolute -left-2 w-10 h-10 rounded-full bg-black border border-white/10 flex items-center justify-center group-hover:rotate-90 transition-transform">
