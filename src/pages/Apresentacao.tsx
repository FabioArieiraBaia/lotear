            ...
            <div className="pointer-events-auto bg-black/70 backdrop-blur-[50px] border border-white/10 rounded-[3rem] p-10 shadow-[0_40px_100px_rgba(0,0,0,0.8)] relative overflow-y-auto max-h-[calc(100vh-160px)] custom-scrollbar">
              ...
              <div className="flex justify-between items-start mb-8">
                <div>
                  ...
                  <div className={`inline-flex items-center gap-2.5 px-4 py-1.5 rounded-xl text-[10px] font-black uppercase tracking-widest border ${
                    displayLote.status === 'Disponível' ? 'bg-emerald-500/10 border-emerald-500/20 text-emerald-400' :
              ...
              {/* AMBIENT GLOW */}
              <div className={`absolute -bottom-24 -left-24 w-48 h-48 blur-[100px] rounded-full opacity-30 pointer-events-none transition-colors duration-1000 ${
                displayLote.status === 'Disponível' ? 'bg-emerald-500' :
